...
class AsyncRequestAcquisition(AbstractAsyncRequestAcquisition):
    ...
    @override
    async def async_get_response(self, session: aiohttp.ClientSession):
    ...
    @override
    async def json_session_async_source(self):
        """호출 시작점"""
...
class CoinExchangeRestClient:        
    async def async_request_data(self, url: str):
        """비동기 호출 함수"""
    ...
    async def get_coin_all_info_price(self, coin_name: str):
        """코인데이터 호출"""
